...
const About = ({ aboutData }: { aboutData?: about }) => {
            ...
            <div className="flex items-center gap-4 md:mt-4">
              ...
              {callUrl.trim() && (
                <Link
                  href={callUrl}
                  target="_blank"
                  className="text-blue-600 flex items-center gap-1 hover:bg-blue-50 hover:dark:bg-blue-900/10 py-2 px-4 transition-colors rounded-md"
                >
