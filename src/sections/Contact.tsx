  ...
  return (
    <div id="contact" className={`flex flex-col mt-4 tablet:w-4/5 mx-auto`}>
        ...
        <div className="grid laptop:grid-cols-3 mx-auto w-full md:grid-cols-2 mt-4 flex-wrap">
          ...
          <div className="flex items-center p-3 ">
           ...
           text-white justify-center p-2"
            ...
            <p className="ml-4">
              <a target="_blank" rel="noreferrer" href="tel:+250790077264">
                +250 790077264
              </a>
            </p>
          </div>
      ...
      <Slide direction="up" triggerOnce>
        <form
          onSubmit={sendEmail}
          className="flex flex-col w-full max-w-[700px]  mx-auto items-center"
        >
          ...
          <div className="relative w-full duration-500 flex flex-col-reverse px-2 py-1 justify-end">
            <textarea
              ...
              className=" w-full min-h-[10vh] max-h-[40vh]              outline-none z-[1] bg-transparent border-[1px] rounded-[0.3em] border-blue-600 min-w-[200px] py-1 px-2"
              required
            />
            <label htmlFor="" className={``}>
              Message:
