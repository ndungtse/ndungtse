...
const Fields = () => {
  ...
  return (
    <div id='fields' className={`w-full bg-gradient-to-b ${themeClass.bgAlt1}  pt-[10vh] laptop:pt-6 justify-center flex flex-col`}>
        <h1 className='text-2xl text-center font-semibold'>Fields</h1>
        <div className="grid py-7 gap-3 desktop:grid-cols-4 items-center justify-center tablet:grid-cols-2
